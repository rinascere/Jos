...
.LM39:
	...
	movl	%eax, 4(%esp)
	call	cprintf
	.stabn	68,0,40,.LM40-.LFBB4
.LM40:
	movl	$0, 4(%esp)
	movl	$.LC7, (%esp)
	call	cprintf
	.stabn	68,0,41,.LM41-.LFBB4
.LM41:
	movl	$255, 8(%esp)
	movl	$13, 4(%esp)
	movl	%ebx, (%esp)
	call	memset
	.stabn	68,0,42,.LM42-.LFBB4
.LM42:
	movl	%edi, 8(%esp)
	movl	%ebx, 4(%esp)
	movl	$.LC8, (%esp)
	call	cprintf
	.stabn	68,0,43,.LM43-.LFBB4
.LM43:
	movsbl	-9(%ebp),%eax
	movl	$.LC9, (%esp)
	movl	%eax, 4(%esp)
	call	cprintf
	.stabn	68,0,48,.LM44-.LFBB4
.LM44:
	movl	$5, (%esp)
	call	test_backtrace
	.p2align 4,,7
